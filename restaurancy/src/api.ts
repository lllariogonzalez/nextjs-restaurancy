...
const api = {
  list: async (): Promise<Restaurant[]> => {
    ...
    const [, ...data] = await fetch('https://docs.google.com/spreadsheets/d/e/2PACX-1vSTJoaW5Ti0T8bPH70oVgd-aIuJVjYqFr9uk7AuDu0IkAZ5-8_b6pjuprTicomYCllCbWGEVQl-oJ0v/pub?output=csv').then(res => res.text()).then(text => text.split('\n'))
